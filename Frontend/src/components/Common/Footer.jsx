...
const Footer = () => {
  return  <footer className="border-t py-12">
    ...
    <div>
       ...
       <li>
        {/* <link to ="#">Men's top Wear</link> */}
        <Link to="#" className="hover:text-gray-600 transition-colors">Men's Buttom wear</Link>
       </li>
       <li>
        {/* <link to ="#">Men's top Wear</link> */}
        <Link to="#" className="hover:text-gray-600 transition-colors">Women's Buttom wear</Link>
       </li>
        </ul>
    </div>
     {/* {support link} */}
    ...
    {/* {footer bottom } */}
    <div className="container mx-auto mt-12 px-4 lg:px-0 border-top border-gray-200 pt-6">
